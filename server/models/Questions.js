...
const ConsultantQuestions = mongoose.model(
  "ConsultantQuestions",
  consultantQuestionsSchema
);
const SoftwareDeveloperQuestions = mongoose.model(
  "SoftwareDeveloperQuestions",
  softwareDeveloperQuestionsSchema
);
const InternQuestions = mongoose.model(
  "InternQuestions",
  internQuestionsSchema
);
const CommonQuestions = mongoose.model(
  "CommonQuestions",
